...
\caption{Fish Creek taken from R44 helicopter. Notice the progression of ice-wedge polygon development on the floodplains to uplands.}
\end{figure}
...
\hypertarget{insert-30-year-normal-precipitation-plot}{%
\section{Insert 30 year normal precipitation plot}\label{insert-30-year-normal-precipitation-plot}}
...
month\_order \textless- c( ``Oct'', ``Nov'', ``Dec'', ``Jan'', ``Feb'', ``Mar'', ``Apr'', ``May'', ``Jun'', ``Jul'', ``Aug'', ``Sep'')
...
\hypertarget{calculate-the-average-temperature-for-each-day-across-all-years-1}{%
\chapter{Calculate the average temperature for each day across all years}\label{calculate-the-average-temperature-for-each-day-across-all-years-1}}

avg\_precip \textless- data\_long \%\textgreater\%
group\_by(Date) \%\textgreater\%
summarise(Avgprecip = mean(Precip, na.rm = TRUE))

\hypertarget{create-the-combined-line-graph-1}{%
\chapter{Create the combined line graph}\label{create-the-combined-line-graph-1}}
