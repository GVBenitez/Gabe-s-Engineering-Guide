...
towns <- data.frame(
  name = c("Anchorage", "Fairbanks", "Prudhoe Bay", "Nuiqsut", "Umiat", "Utqiaġvik", "Juneau"),
  lat = c(61.2176, 64.8378, 70.2556, 70.2175, 69.3672, 71.2906, 58.3019),
  lon = c(-149.8997, -147.7164, -148.3384, -150.9764, -152.1394, -156.7886, -134.4197)
)
